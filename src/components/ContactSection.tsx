        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 id="contact-heading" className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-foreground leading-tight">
                Your wish awaits —{" "}
          ...
          {/* Right: Form */}
          <div className="rounded-2xl border border-border bg-card-gradient p-5 sm:p-6 md:p-8">
            {submitted ? (
